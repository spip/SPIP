...
function balise_INCLURE_dist($p)
{
    ...
    if (isset($_contexte['fond'])) {
        ...
        $p->code = sprintf(CODE_RECUPERER_FOND, $f, $_l, implode(',', $_options), "_request('connect')");
...
function balise_AUTORISER_dist($p)
{
    ...
    $p->code = '((function_exists("autoriser")||include_spip("inc/autoriser"))&&autoriser('.implode(', ',
            $_code).')?" ":"")';
    $p->interdire_scripts = false;
