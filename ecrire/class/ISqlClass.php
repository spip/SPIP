...
Interface ISql
{
	...
	function insert($table, $champs, $valeurs, $where='', $serveur='', $option=true);

	function update($table, $champs, $where='', $serveur='', $option=true);

	function delete($table, $where='', $serveur='', $option=true);

	function replace($table, $couples, $where='', $serveur='', $option=true);
	...
	function showbase($base, $serveur='', $option=true);
