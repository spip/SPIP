 ...
 * @uses http_no_cache()
 */
function minipublic_install_debut_html($options = []){
 ...
 */
function minipublic_install_fin_html(){
	return "\n\t</div>\n</body>\n</html>";
}
 ...
 *   Corps de la page
 * @param array $options
 *   @see minipublic_install_debut_html()
 ...
 * @return string
 *   HTML de la page
 * @uses minipublic_install_debut_html()
 * @uses minipublic_install_fin_html()
 *
 */
function minipublic($corps, $options = []){
	...
	$html = minipublic_install_debut_html($options)
		. $header
		. $corps
		. $footer
		. minipublic_install_fin_html();
 ...
 * @return string
 */
function minipublic_erreur($message_erreur = null, $options = []){
